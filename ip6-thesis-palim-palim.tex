...
\section{Reflexion}
Testpersonen für die Spieletests von Palim-Palim wurden über einen Newsletter der Organisation «terzStiftung» \cite{noauthor_terzstiftung_nodate} gesucht. Dieser Aufruf war nicht erfolgreich. Auch sonst gestaltete sich die Suche nach Testpersonen eher schwierig. Viele angefragte Personen standen während des Testzeitraums nicht zur Verfügung. Diese Umstände führten zu einer geringen Anzahl an Testpersonen. Zudem passten diese nicht vollständig zur Zielgruppe. Die betagten Testenden sind eher zu erfahren im Umgang mit Spielen, da sie bereits sehr viele und auch anspruchsvollere Spiele testeten. Die Kinder sind zwei bis drei Jahre zu alt. Ebenfalls sind die Testpärchen nicht verwandt miteinander. Auch sollte bei einem nächsten Spieletest Palim-Palim remote getestet werden, um die Testumgebung möglichst real zu gestalten. Bei den beiden durchgeführten Spieletests war dies aufgrund der Verfügbarkeit der Testpersonen nicht möglich.\\\\
