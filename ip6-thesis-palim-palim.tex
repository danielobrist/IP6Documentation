...
Ausserdem hat eine Studie von Bos et al. untersucht, wie sich das Vertrauen zwischen Spielenden in einem Social Dilemma-Spiel \cite{harrod_social_1983} via Videochat entwickelt \cite{bos_short_2001}. Dabei hat sich gezeigt, dass zwischen Teilnehmenden des Videochats ein vergleichbares Vertrauen entsteht, wie in Durchgängen, welche Face-To-Face durchgeführt werden. Die Studie notiert allerdings auch, dass es verglichen mit den vor Ort durchgeführten Spielen länger dauert, bis dasselbe Niveau an Vertrauen aufgebaut wird.\\\\
