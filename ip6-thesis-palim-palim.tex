...
\chapter{Implementation}
	\section{Architektur}
In diesem Kapitel werden die einzelnen Komponenten von Palim-Palim und deren Funktionen vorgestellt. Die Struktur von Palim-Palim wurde bewusst so aufgebaut, dass die Video-Chat-Funktionalität möglichst von der Game-Logik entkoppelt ist. Dadurch ist es einfacher, den Video-Chat auch in anderen Spielen zu integrieren.
