...
\chapter{Gamedesign}
	...
	\section{Spielvarianten/Videomodi}
...
\chapter{Technologien}
	Palim-Palim kombiniert die Funktionalitäten einer Video-Chat-Applikation mit einem Multiplayer-Spiel. Um diesen Anforderungen gerecht zu werden, wurden entsprechende Technologien zur Umsetzung evaluiert. Dabei fiel die Wahl auf WebRTC (Web Real-Time Communication) zur Übertragung der Multimedia-Daten, sowie Three.js als 3D-Bibliothek für die Gestaltung und Umsetzung der 3D-Gameplay-Szene. In diesem Kapitel wird als erstes die Technologiewahl begründet. Anschliessend werden die verwendeten Frameworks und deren Funktionen vorgestellt.
	
	\section{Technologiewahl}
	- Anforderungen -Multiplayer -VideoChat -Zugriff auf Video für Interatkionen, Filter
	- Möglichkeiten: Unity
