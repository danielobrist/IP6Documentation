...
\usepackage[backend=bibtex,style=ieee,language=german]{biblatex}
...
\chapter{Implementation}
	\section{Technologien}
			\subsection{WebRTC}
WebRTC ist ein Open-Source-Projekt, das die Echtzeitkommunikation von Audio, Video und Daten in Web- und nativen Anwendungen ermöglicht \cite{noauthor_webrtc_2011}. Die Technologie ist in allen modernen Browsern sowie auf nativen Clients für alle wichtigen Plattformen verfügbar und ist eine Empfehlung des World Wide Web Consortium (W3C) \cite{noauthor_webrtc_2021} und ein Standard der Internet Engineering Task Force (IETF) \cite{noauthor_support_2021}. Dabei wird zwischen zwei Browsern eine Peer-To-Peer-Verbindung aufgebaut, worüber die Daten gestreamt werden. Auf der Peer-To-Peer-Verbindung lassen sich auch eigene DataChannels erstellen, die z.B. zur Übertragung von Text-Nachrichten, Positions-Daten von Game-Objekten oder sogar Files zwischen den Peers verwendet werden können [https://webrtc.ventures/2016/05/5-uses-of-the-data-channel/].
			\subsubsection{Signaling}
			WebRTC verwendet die RTCPeerConnection \cite{noauthor_rtcpeerconnection_nodate} JavaScript API, um Streaming-Daten zwischen Browsern zu kommunizieren. Zusätzlich wird aber auch einen Mechanismus benötigt, um die Kommunikation zu koordinieren und Kontrollnachrichten zu senden. Dieser Prozess wird als \textit{Signaling} bezeichnet. Signaling-Methoden und -protokolle sind von WebRTC nicht spezifiziert und können je nach Anwendungsfall entsprechend gewählt werden.\\		
In diesem Projekt wurde Socket.IO für die Signalisierung verwendt, da es sich mit seinem integrierten Room-Konzept für eine Video-Chat-App anbietet. Palim-Palim verwendet eine Node.js Server-Applikation (implementiert in server.js), welche als Signaling-Server fungiert. Der Server hat dabei folgende zwei Aufgaben. \\\\
