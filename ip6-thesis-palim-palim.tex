...
\todo{Ergebnisse aus Spieletest zusammenfassen}
Die Ergebnisse aus den Spieletests waren nicht aussagekräftig. Dies führte dazu, dass die aufgestellten Forschungsfragen nicht abschliessend beantwortet werden können. Gleichwohl lässt sich über Verbesserungsmöglichkeiten bezüglich des Gameplays von Palim-Palim nur mutmassen. Bezüglich Game Design steht Palim-Palim noch am Anfang seines möglichen Weges. Eine Fortführung des Projekts sollte unbedingt regelmässige Tests in den Entwicklungsprozess integrieren. So kann fortlaufendes Feedback der Zielgruppen eingeholt und in der Weiterentwicklung berücksichtigt werden.\\\\
