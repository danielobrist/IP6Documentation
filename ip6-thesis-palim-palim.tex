...
\begin{abstract}	
Palim-Palim ist ein Videospiel für Kinder und betagte Menschen. Das Spiel beinhaltet einen Videochat und dient primär der Kommunikation zwischen Grosseltern und ihren Enkelkindern. Es schafft eine solide Basis für weitere Videospiele mit integriertem Videochat. Mit dem Spiel wurde der Einfluss des Videochats auf die Kommunikation und das Spielerlebnis erforscht. Dabei zeigte sich das grosse Potenzial von Videochat-Spielen, Beziehungen zwischen Generationen auch über weite Distanzen zu fördern. Spieletests mit Kindern weisen darauf hin, dass sich Videos als Gameplay-Elemente eignen.
\end{abstract}
...
\end{quote}
Die verwendeten Begriffe «Kind» und «betagte Person» werden im Rahmen von Palim-Palim wie folgt definiert:
...
Für beide Testpersonen ist unklar, dass die Abbildung mit den Erklärungen noch nicht zum Spiel gehört. Sie versuchten bereits das Einkaufsobjekt zu verschieben und die Einkaufsliste zu öffnen. Die Anweisung «Frag dein Enkelkind nach Objekten» war für eine Person unklar, denn sie fragte das Kind, was dieses gerne hätte, obwohl sie nach einem Gegenstand ihrer Einkaufsliste fragen müsste. Die Senior:innen waren sich uneinig, ob es sinnvoll ist, die Anleitung vor jedem Spielstart anzuzeigen. Eine Testperson findet dies wichtig, damit klar ist, was gemacht werden soll, die andere Person ist der Meinung, dass es mühsam sei und sie in dieser kurzen Zeit die simplen Funktionalitäten nicht vergessen habe.\\\\
...
\end{itemize}
Für beide Protokolle müssen Server bereitgestellt werden, welche den WebRTC-Clients bekannt sein müssen. Die Adressen dieser STUN- und TURN-Server müssen beim Aufbau der Peer-Connection der Clients an den Signaling-Server übermittelt werden \cite{noauthor_webrtc_nodate}. Wie dies in Palim-Palim umgesetzt wurde, ist im Kapitel \ref{server} genauer beschrieben.\\\\
...
\textbf{Hinzufügen des Zahlungsprozesses}\\
...
\paragraph{Labyrinth} Ein halb-transparentes Labyrinth auf dem Screen und beide Spieler starten auf verschiedenen Seiten. Mit dem Finger wird ein Pfad gezeichnet, und die Spielenden treffen müssen sich treffen.
...
\paragraph{Zaubersprüche} Mittels Computer Vision werden Handbewegungen auf dem Videostream erkannt. In Kombination mit Audio-Erkennung könnte so ein Repertoire an Zaubersprüchen aufbaut werden. Haben die Spielenden diese gelernt, können sie lustige Filter auf den Video-Stream des Gegenüber «zaubern».
