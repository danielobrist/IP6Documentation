...
Im Spiel selbst konnte aber auch bei dieser Fragestellung kein signifikanter Unterschied zwischen den beiden Modi mit und ohne Video festgestellt werden. Der Videochat in Palim-Palim hat die Kommunikation zwischen den Spielenden also nicht gefördert. Es muss allerdings erwähnt werden, dass Palim-Palim sehr wenige Spielelemente besitzt, welche eine Kommunikation zwischen den Spielenden erfordert. Es wäre angebracht, mehr kommunikationsfördernde Teile in das Gameplay zu integrieren, bevor hierzu eine repräsentative Aussage gemacht werden kann.\\\\
