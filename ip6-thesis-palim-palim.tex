...
Bei der Umleitung des Datenverkehrs über den TURN-Server die Daten nicht interpretiert oder modifiziert. Dies ist so im TURN-Standard definiert. Das heisst, die Verwendung eines TURN-Servers fügt dem WebRTC-Datenverkehr keine Sicherheitsschwachstellen hinzu.\\\\
...
\caption[Caption for LOF]{Klassendiagramm der wichtigsten Komponenten von Palim-Palim.}
...
Eine Reflexion der gewählten Ansätze und Lösungen sowie mögliche Weiterentwicklungen von Palim-Palim sind in den nachfolgenden Kapiteln beschrieben.
